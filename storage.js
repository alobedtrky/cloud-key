...
let state={products:[],orders:[],coupons:[],codes:[],audit:[]},pool=null,seedPath='',queue=Promise.resolve(),backend='file';
function norm(db={}){db.products||=[];db.orders||=[];db.coupons||=[];db.codes||=[];db.audit||=[];return db}
